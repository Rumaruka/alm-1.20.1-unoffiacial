...
public class ItemPowerArmor extends ArmorItem implements IToolWithCharge {
	...
	public ItemPowerArmor(ArmorMaterial pMaterial, Type pSlot, Properties pProperties) {
		this(ItemTiers.getTier(pMaterial).getPowerToolType(), pMaterial, pSlot, pProperties);
	}

	public ItemPowerArmor(PowerToolType ptt, ArmorMaterial pMaterial, Type pSlot, Properties pProperties) {
