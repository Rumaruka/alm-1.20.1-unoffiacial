...
public abstract class AbstractMachine<A extends AbstractContainerMenu> extends RandomizableContainerBlockEntity {
    ...
    public static class ScreenALMBase<T extends AbstractContainerMenu> extends AbstractContainerScreen<T> {
        ...
        protected void renderLabels(GuiGraphics p_230451_1_, int p_230451_2_, int p_230451_3_) {
            this.drawGuiContainerForegroundLayer(p_230451_1_, p_230451_2_, p_230451_3_);
        }
        ...
        protected void drawGuiContainerForegroundLayer(GuiGraphics gg, int mouseX, int mouseY) {
            if (renderTitleText) {
                ...
                gg.drawString(font, this.getTitle(), titleTextLoc.getFirst(), titleTextLoc.getSecond(), 4210752);

            }
            if (renderInventoryText) {
                gg.drawString(font, this.inventoryText.get(), invTextLoc.getFirst(), invTextLoc.getSecond(), 4210752);
        ...
        protected void renderBg(GuiGraphics pGuiGraphics, float pPartialTick, int pMouseX, int pMouseY) {
            this.drawGuiContainerBackgroundLayer(pGuiGraphics, pPartialTick, pMouseX, pMouseY);
        }

        protected void drawGuiContainerBackgroundLayer(GuiGraphics pGuiGraphics, float partialTicks, int mouseX, int mouseY) {
