...
import me.haydenb.assemblylinemachines.block.machines.BlockGreenhouse.Soil;
import me.haydenb.assemblylinemachines.block.machines.BlockGreenhouse.Sprout;
...
public class GreenhouseCrafting implements Recipe<TEGreenhouse>, RecipeCategoryBuilder.IRecipeCategoryBuilder {
	...
	@Override
	public ItemStack assemble(TEGreenhouse container, RegistryAccess registryAccess) {
